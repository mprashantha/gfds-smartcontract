...
import logo from "image/gfdsLogo.jpg"
...
const App = ({ isServerInfo }) => {
  ...
  return (
    ...
    <Layout style={{ height: "450vh", overflow: "auto" }}>
      <Router>
      <div className="topBanner">
        <Header style={styles.header}>
        <img src={logo} width="150" height={55}/>
          ...
          >
            ...
            <Menu.Item key="flyers" onClick={() => setInputValue("explore")} >
              <NavLink to="/Flyers">🛒 Flyers</NavLink>
            </Menu.Item>
            <Menu.Item key="parcel">
              <NavLink to="/">🖼 Parcels</NavLink>
            </Menu.Item>
